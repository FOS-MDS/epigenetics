---
title: "Epigenomics Practical 2020"
...
The following files are available in the `/data` directory of this Project. 

* Tissue data subset.csv
* Tissue data chromosome 22.csv
* Tissue data chromosome 22 significant.csv
* Significant probes.bed
* TissueData chr22.RData

At the end of the practical upload your work to Brightspace as a PDF document with your name(s) on top of the first page. The file name should contain your surname(s). 
