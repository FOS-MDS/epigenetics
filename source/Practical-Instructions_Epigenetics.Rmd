...
*You can use `by` to calculate a mean and sd of groups*
...
*Have a look at `geom_violin` and geom_boxplot. Put the annotation on the x-axis and the DNA methylation level on the y-axis*
...
*You can add a secondary group by adding that group as fill colour!*
...
*Have a look at the `table` function*
